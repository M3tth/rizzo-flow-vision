...
class BooleanQuestion(BaseQuestion):
    ...
    true_description: Text = "The proposition is supported by the evidence."
    false_description: Text = "The proposition is contradicted by the evidence."
...
class ChoiceQuestion(BaseQuestion):
    type: Literal["choice"]
    options: list[Option] = Field(min_length=2, max_length=23)
...
class ScoreQuestion(BaseQuestion):
    type: Literal["score"]
    levels: list[Text] = Field(min_length=2, max_length=23)
...
class NumericQuestion(BaseQuestion):
    ...
    anchors: list[Anchor] = Field(min_length=2, max_length=23)
